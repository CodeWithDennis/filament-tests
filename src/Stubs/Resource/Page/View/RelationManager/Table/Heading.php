...
class Heading extends Base
{
    ...
    {
        return 'has the correct table heading on the '.str($this->getRelationManager($this->relationManager)->getRelationshipName())->lcfirst().' relation manager on the view page';
    }
