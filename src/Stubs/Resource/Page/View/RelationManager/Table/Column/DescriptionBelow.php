...
class DescriptionBelow extends Base
{
    ...
    {
        return 'has the correct descriptions (below) on the '.str($this->getRelationManager($this->relationManager)->getRelationshipName())->lcfirst().' relation manager on the view page';
    }
