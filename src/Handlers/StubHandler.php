    ...
    public function getStubs(): Collection
    {
        ...
        $relationManagerStubs = $resourceRelationManagers->map(function ($relation) use ($resource) {
            return [
                ...
                \CodeWithDennis\FilamentTests\Stubs\Resource\Page\Edit\RelationManager\Column\CannotRender::make($resource, $relation)->get(),
                \CodeWithDennis\FilamentTests\Stubs\Resource\Page\Edit\RelationManager\Column\DescriptionAbove::make($resource, $relation)->get(),
                \CodeWithDennis\FilamentTests\Stubs\Resource\Page\Edit\RelationManager\Column\DescriptionBelow::make($resource, $relation)->get(),
                \CodeWithDennis\FilamentTests\Stubs\Resource\Page\Edit\RelationManager\Column\Exist::make($resource, $relation)->get(),
                \CodeWithDennis\FilamentTests\Stubs\Resource\Page\Edit\RelationManager\Column\ExtraAttributes::make($resource, $relation)->get(),
                \CodeWithDennis\FilamentTests\Stubs\Resource\Page\Edit\RelationManager\Column\Search::make($resource, $relation)->get(),
                \CodeWithDennis\FilamentTests\Stubs\Resource\Page\Edit\RelationManager\Column\SearchIndividually::make($resource, $relation)->get(),
                \CodeWithDennis\FilamentTests\Stubs\Resource\Page\Edit\RelationManager\Column\Select::make($resource, $relation)->get(),
                \CodeWithDennis\FilamentTests\Stubs\Resource\Page\Edit\RelationManager\Column\Sort::make($resource, $relation)->get(),
